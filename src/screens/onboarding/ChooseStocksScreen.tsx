...
export default function ChooseStocksScreen() {
  ...
  const handleContinue = async () => {
    ...
    // Navigate to Free Member screen (Step 4)
    navigation.navigate('FreeMember');
  };

  const handleSkip = () => {
    // Navigate to Free Member screen even if no stocks selected
    navigation.navigate('FreeMember');
  };
